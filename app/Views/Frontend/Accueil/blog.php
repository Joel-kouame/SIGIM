                     ...
                     <section>
                        <div class="post-main-container hr-line">
                           ...
                           <div class="post-container">
                              <a href="<?= base_url('eau')?>" class="h6">Should Medical School
                                 Last Just 3 Years?</a>
                              <p>28 May 2022</p>
                           </div>
                        </div>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
               <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                     <div class="blog-box p-0 resp-30">
                        ...
                        <div class="blog-content">
                           <h3><a href="<?= base_url('eau')?>">Spending More and Getting Less
                                 for Health Care</a>
                           </h3>
                           <ul>
                           ...
                           <a href="<?= base_url('eau')?>" class="r-btn">Read More</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                     <div class="blog-box pt-50">
                        <div class="img-icon">
                           <img src="../asset/images/blog-img6.jpg" alt="img">
                           <div class="img-overlay"></div>
                           <p class="text-center">08<br>
                              july
                           </p>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                     <div class="blog-box pt-50">
                        <div class="img-icon">
                           <img src="../asset/images/blog-img7.jpg" alt="img">
                           <div class="img-overlay"></div>
                           <p class="text-center">08<br>
                              july
                           </p>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                     <div class="blog-box pt-50">
                        <div class="img-icon">
                           <img src="../asset/images/blog-img8.jpg" alt="img">
                           <div class="img-overlay"></div>
                           <p class="text-center">08<br>
                              july
                           </p>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                     <div class="blog-box pt-50">
                        <div class="img-icon">
                           <img src="../asset/images/blog-img9.jpg" alt="img">
                           <div class="img-overlay"></div>
                           <p class="text-center">08<br>
                              july
                           </p>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                     <div class="blog-box pt-50">
                        <div class="img-icon">
                           <img src="../asset/images/blog-img10.jpg" alt="img">
                           <div class="img-overlay"></div>
                           <p class="text-center">08<br>
                              july
                           </p>
                  ...
                  <div class="col-lg-12 col-md-12 col-12">
                     <nav aria-label="Page navigation example" class="page-navigation">
                        <ul class="pagination justify-content-center ">
                           <li class="page-item">
                              <a class="page-link" href="javascript:;" tabindex="-1" aria-disabled="true"><i

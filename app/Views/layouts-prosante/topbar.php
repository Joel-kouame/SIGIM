                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <div id="notifications">
                        ...
                        <h6 class="dropdown-item-text font-15 m-0 py-3 border-bottom d-flex justify-content-between align-items-center">
                            ...
                            Notifications <span class="badge bg-soft-primary badge-pill"><?= count($alert_notif);  ?></span></h6>
                        ...
                        ?>
                                    ...
                                    <audio id="notificationSound" autoplay="autoplay">
                                ...
                                <div class="notification-menu" <?php if ($notify['vue_notif'] == 0) { ?> style="background-color:#f8f9fa;" <?php } ?> data-simplebar>
                                    ...
                                    <a href="#" class="dropdown-item py-3">
                                        <small class="float-end text-muted ps-2">
                                            <?= dateSince($notify['created_at']); ?><br>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <img src="<?= base_url('public/assets/images/users/user-4.jpg') ?>" alt="profile-user" class="rounded-circle me-2 thumb-sm" />
                        <div>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="<?= base_url('/Prosante/logout'); ?>"><i class="ti ti-power font-16 me-1 align-text-bottom"></i> Logout</a>
                </div>

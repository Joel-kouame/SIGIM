...
<div class="topbar">  
    ...
    <div class="brand">
        <a href="index.php" class="logo">
            <span>
                <img src="<?= base_url('public/assets/images/logo1.png'); ?>" alt="logo-small" class="logo-sm">
            </span>
            <span>
                <img src="<?= base_url('public/assets/images/logo1.png'); ?>" alt="logo-large" class="logo-lg logo-light">
                <img src="<?= base_url('public/assets/images/logo4.png'); ?>" alt="logo-large" class="logo-lg logo-dark">
            </span>
        </a>
    </div>
    <!--end logo-->  

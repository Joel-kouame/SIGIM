                                ...
                                <div class="tab-content chat-list" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="general_chat">
                                        ...
                                        <?php foreach ($contacts as $contact) : ?>
                                            <a href="<?= base_url('patient/chat/' . $contact['id_prosante']); ?>" class="media <?php if ($contact['conversations'] != NULL) { if (($contact['conversations']['sender_id'] !== session()->get('id')) and ($contact['conversations']['last_message_status'] == 0)) {
                                                                                                                                    echo 'new-message';
                                                                                                                                } } ?>">

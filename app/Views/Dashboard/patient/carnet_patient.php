                                                    ...
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table" id="datatable_1">
                                                                ...
                                                                <tbody>
                                                                <?php if (isset($infos) && $infos > 0) : ?>
                                                                    <?php foreach ($infos as $item) : ?>
                                                                        <tr>
                                                                            <td><?= $item['date'];?></td>
                                                                            <td>
                                                                                <p><img src="<?= base_url($item['photo']); ?>" alt="" class="rounded-circle thumb-sm me-1"><?= $item['nom'] . ' ' . $item['prenom'];?></p>
                                                                            </td>
                                                                            <td><?= $item['service'];?></td>
                                                                                                ...
                                                                                                <ul>
                                                                                                    <li><h5>Constante</h5>
                                                                                                        <ul>
                                                                                                            ...
                                                                                                            <li>Tension : <?= $item['tension'];?></li>
                                                                                                            <li>Temperature : <?= $item['temperature'];?> °C</li>
                                                                                                        </ul>
                                                                                                    </li>
                                                                                                    <li><h5>Ordonnance</h5>
                                                                                                        <ul>
                                                                                                            <li><?= $item['medicament1'];?></li>
                                                                                                            <li><?= $item['medicament2'];?></li>
                                                                                                            <li><?= $item['medicament3'];?></li>
                                                                                                        </ul>
                                                                                                    </li>
                                                                                                </ul>
                                                                                            </div>
                                                                ...
                                                                <?php else : ?>
                                                                    <tr>
                                                                        <td colspan="7">Aucune consultation trouvé.</td>
                                                                    </tr>
                                                                <?php endif; ?>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table" id="datatable_1">
                                                                ...
                                                                <tbody>    
                                                                <?php if (isset($medocs) && $medocs) : ?>
                                                                    <?php foreach ($medocs as $ordonn) : ?>  
                                                                    <tr>
                                                                        <td><h5 class="text-primary"><?= $ordonn['date'] ;?></h5></td>
                                                                        <td><img src="<?= base_url($ordonn['photo']); ?>" alt="" class="rounded-circle thumb-sm me-1"><?= $ordonn['nom'] . '  '. $ordonn['prenom'] ;?></td>
                                                                        <td><?= $ordonn['service'] ;?></td>
                                                                        <td>
                                                                            <!-- Button trigger modal -->
                                                                ...
                                                                <?php else : ?>
                                                                    <tr>
                                                                        <td colspan="7">Aucune ordonnance trouvé.</td>
                                                                    </tr>
                                                                <?php endif; ?>                                                                 
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table mb-0"> 
                                                                ...
                                                                <tr class="text-align: center">
                                                                    <th data-type="date" data-format="YYYY/DD/MM">Date</th>
                                                                    <th>Nom Alergie</th>
                                                                    <th>Reaction alergique</th>
                                                                    <th>Nom medecin</th>
                                                                </tr>
                                                                </thead>                                                       
                                                                <tbody>
                                                                <?php if (isset($alergie) && $alergie > 0) : ?>
                                                                    <?php foreach ($alergie as $alergies) : ?>
                                                                    <tr class="border-0">
                                                                        <td><?= $alergies['date'];?></td>
                                                                        <td class="border-0 text-danger"><?= $alergies['nom_alergie'];?></td>
                                                                        <td><?= $alergies['reaction_alergique'];?></td>
                                                                        <td><?= $alergies['nom'] .' '. $alergies['prenom'];?></td>
                                                                    </tr> 
                                                                    <?php endforeach; ?>
                                                                <?php else : ?>
                                                                    <tr>

            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <h6 class="dropdown-item-text font-15 m-0 py-3 border-bottom d-flex justify-content-between align-items-center">
                        Messages <div id="count_new_msg" class="badge bg-soft-primary badge-pill">0</div>
                    </h6>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <div class="notification-menu" data-simplebar>
                        ...
                        <a href="#" class="dropdown-item py-3">
                            ...
                            <span class="float-end text-muted ps-2">
                                <div class="new-message-dot new-message-blink"></div>
                            </span>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <img src="<?= base_url($prosante['photo'] ?: 'upload/images.jpg'); ?>" alt="profile-user" class="rounded-circle me-2 thumb-sm" />
                        <div>
                            <small class="d-none d-md-block font-11">Prosanté</small>
                            <span class="d-none d-md-block fw-semibold font-12"><?= $prosante['nom'] ?: 'Prosanté'; ?>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="<?= base_url('prosante/profile'); ?>"><i class="ti ti-user font-16 me-1 align-text-bottom"></i> Profile</a>
                    <a class="dropdown-item" href="<?= base_url('prosante/profile'); ?>"><i class="ti ti-settings font-16 me-1 align-text-bottom"></i> Paramettre</a>
                    <div class="dropdown-divider mb-0"></div>
                    <a class="dropdown-item" href="<?= base_url('dashboardProsante/logout'); ?>"><i class="ti ti-power font-16 me-1 align-text-bottom"></i>Deconnexion</a>
                </div>

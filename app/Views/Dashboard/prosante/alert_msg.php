...
<?php foreach ($alert_contacts as $alert_contact) : ?>
    ...
    <a href="<?= base_url('prosante/chat/' . $alert_contact['id_patient']); ?>" class="dropdown-item py-3 <?php if ($alert_contact['alert_conversations'] !== NULL) {
        ...
        <div class="media">
            ...
            <div class="media-body align-self-center ms-2 text-truncate">
                ...
                <?php } else { ?>
                    ...
                    <?= substr($alert_contact['alert_conversations']['last_message'], 0, 30); ?>
                    </small>

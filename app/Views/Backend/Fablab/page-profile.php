...
<html lang="en">
    ...
    <?= $this->include('layouts-fablab/left-sidebarp'); ?>
    <?= $this->include('layouts-fablab/topbarp'); ?>
        ...
        <div class="page-content-tab">
            ...
            <div class="container-fluid">
                ...
                <?=
                  $page_title = "Profile";
                  $sub_title = "Pages";
                  $this->include('layouts-fablab/page-title') ; ?>
                                        ...
                                        <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                                            <div class="met-profile-main">
                                                <div class="met-profile-main-pic">
                                                    <img src="<?= base_url('public/assets/images/users/user-4.jpg') ?>" alt="" height="110" class="rounded-circle">
                                    ...
                                    <div class="tab-pane p-3 active" id="Post" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-9">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">                                                    
                                                        <img src="<?= base_url('public/assets/images/small/1.jpg') ?>" alt="" class="img-fluid">
                                                    ...
                                                    <div class="card-body border-bottom-dashed"> 
                                                        <ul class="list-unstyled mb-0">
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <img src="<?= base_url('public/assets/images/users/user-2.jpg') ?>" alt="" class="thumb-md rounded-circle">
                                                                    </div><!--end col-->
                                                                    <div class="col">
                                                                ...
                                                                <ul class="list-unstyled ms-5">
                                                                    <li>
                                                                        <div class="row mt-3">
                                                                            <div class="col-auto">
                                                                                <img src="<?= base_url('public/assets/images/logo-sm.png') ?>" alt="" class="thumb-md rounded-circle">
                                                                            </div><!--end col-->
                                                                            <div class="col">
                                                                                <div class="comment-body ms-n2 bg-light-alt p-3">
                                                                                    <div class="row">
                                                            ...
                                                            <li class="mt-3">
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <img src="<?= base_url('public/assets/images/users/user-1.jpg') ?>" alt="" class="thumb-md rounded-circle">
                                                                    </div><!--end col-->
                                                                    <div class="col">
                                                                        <div class="comment-body ms-n2 bg-light-alt p-3">
                                                                            <div class="row">

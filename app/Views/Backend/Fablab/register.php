<head>
    ...
    <?php $this->include('layouts-fablab/title-meta'); ?>
    <?php $this->include('layouts-fablab/head-css'); ?>
</head>
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <form class="my-4" action="<?= base_url('/Fablab/save_fablab'); ?>" method="post">
                                        <?= csrf_field(); ?>
                                    ...
                                    <div class="m-3 text-center text-muted">
                                        <p class="mb-0">Vous avez déjà un compte ? <a href="<?= base_url('/Fablab'); ?>" class="text-primary ms-2">Connectez-vous maintenant</a></p>
                                    </div>
                                </div><!--end card-body-->
                            </div><!--end card-->
                        </div><!--end col-->

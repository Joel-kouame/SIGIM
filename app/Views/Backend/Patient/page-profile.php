    ...
    <div class="page-wrapper">
      ...
      <!-- Top Bar Start -->
        ...
        <div class="page-content-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                                            <div class="met-profile-main">
                                                <div class="met-profile-main-pic">
                                                    <img src="<?= base_url(isset($user['photo']) ? $user['photo'] : 'upload/images.jpg'); ?>" alt="" height="100" class="rounded-circle">
                                                    <span class="met-profile_main-pic-change">
                                                        <i class="fas fa-camera"></i>
                                                    </span>
                                                </div>
                                                <div class="met-profile_user-detail">
                                                    <h5 class="met-user-name"><?= isset($user['nom']) ? $user['nom'] : 'Admin'; ?></h5>                                                        
                                                    <p class="mb-0 met-user-name-post">UI/UX Designer, Côte d'Ivoire</p>                                                        
                                                </div>
                                            </div>                                                
                                        </div><!--end col-->
                                        ...
                                        <div class="col-lg-4 ms-auto align-self-center">
                                            <ul class="list-unstyled personal-detail mb-0">
                                                <li class=""><i class="las la-phone mr-2 text-secondary font-22 align-middle"></i> <b> phone </b> : +225 <?= isset($user['telephone']) ? $user['telephone'] : 'Admin'; ?></li>
                                                <li class="mt-2"><i class="las la-envelope text-secondary font-22 align-middle mr-2"></i> <b> Email </b> : <?= isset($user['email']) ? $user['email'] : 'Admin'; ?></li>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="card-body border-bottom-dashed"> 
                                                        <ul class="list-unstyled mb-0">
                                                            <li>
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <img src="<?= base_url(isset($user['photo']) ? $user['photo'] : 'upload/images.jpg'); ?>" alt="" class="thumb-md rounded-circle">
                                                                    </div><!--end col-->
                                                                    <div class="col">
                                                            ...
                                                            <li class="mt-3">
                                                                <div class="row">
                                                                    <div class="col-auto">
                                                                        <img src="<?= base_url(isset($user['qr_image']) ? $user['qr_image'] : 'upload/images.png'); ?>" alt="" class="thumb-md rounded-circle">
                                                                    </div><!--end col-->
                                                                    <div class="col">
                                                                        <div class="comment-body ms-n2 bg-light-alt p-3">
                                                                            <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="blog-card">
                                                            <img src="<?= base_url(isset($user['qr_image']) ? $user['qr_image'] : 'upload/images.png'); ?>" alt="" class="img-fluid rounded">
            ...
            <!--Start Rightbar-->
            <?= $this->include('layouts/right-sidebar'); ?>
            <!--end Rightbar-->

                        ...
                        <div class="card-body">
                            <div class="table-responsive browser_users">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><img src="<?= base_url('public/assets/images/logos/chrome.png') ?>" alt="" height="20" class="me-2">Chrome
                                        </td>
                                    ...
                                    <tr>
                                        <td><img src="<?= base_url('public/assets/images/logos/micro-edge.png') ?>" alt="" height="20"
                                    ...
                                    <tr>
                                        <td><img src="<?= base_url('public/assets/images/logos/in-explorer.png') ?>" alt="" height="20"
                                    ...
                                    <tr>
                                        <td><img src="<?= base_url('public/assets/images/logos/opera.png') ?>" alt="" height="20" class="me-2">Opera
                                        </td>
